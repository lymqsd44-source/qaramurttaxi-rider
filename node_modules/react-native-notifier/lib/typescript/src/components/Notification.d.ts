...
import { type ImageSourcePropType, type TextStyle, type ImageStyle, type ViewStyle, type StyleProp } from 'react-native';
...
declare const NotificationComponent: React.FunctionComponent<NotificationComponentAllProps>;
