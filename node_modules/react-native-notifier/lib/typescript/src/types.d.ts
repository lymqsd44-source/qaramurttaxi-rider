...
type ContainerStyleParam = ((translateYAnimatedValue: Animated.Value) => AnimatedViewProps['style']) | AnimatedViewProps['style'];
...
export interface ShowNotificationParams<ComponentType extends ElementType = ElementType> extends ShowParams {
...
export interface NotifierInterface {
    showNotification<ComponentType extends ElementType = typeof NotificationComponent>(params: ShowNotificationParams<ComponentType>): void;
