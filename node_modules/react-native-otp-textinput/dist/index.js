...
class OTPTextView extends Component {
    ...
    render() {
        const { inputCount, offTintColor, tintColor, defaultValue, inputCellLength, containerStyle, textInputStyle, keyboardType, testIDPrefix, autoFocus, onFocus, onBlur, disabled, ...textInputProps } = this.props;
        ...
        for (let i = 0; i < inputCount; i += 1) {
            ...
            TextInputs.push(<TextInput ref={e => {
                ...
                }} key={i} autoCorrect={false} keyboardType={keyboardType} autoFocus={autoFocus && i === 0} value={otpText[i] || ''} style={inputStyle} maxLength={this.props.inputCellLength} onFocus={() => {
                    this.props.onFocus();
                    this.onInputFocus(i);
                }} onBlur={() => this.props.onBlur()} onChangeText={text => this.onTextChange(text, i)} multiline={false} onKeyPress={e => this.onKeyPress(e, i)} selectionColor={_tintColor} cursorColor={_tintColor} editable={!disabled} {...textInputProps} testID={`${testIDPrefix}${i}`}/>);
        }
